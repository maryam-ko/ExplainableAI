...
df = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/03_normalise_data/MatrixCSVs/NormalisedMatrix.csv', index_col=0)
print(df)
...
ax.set_ylabel('')
plt.tight_layout()
plt.savefig('protein_correlation_heatmap2.png', dpi=300)
plt.show()
...
sns.clustermap(
    ...
    xticklabels=False,   
    yticklabels=False
).savefig('protein_correlation_clustermap_with_dendrograms.png', dpi=300)
plt.show()
