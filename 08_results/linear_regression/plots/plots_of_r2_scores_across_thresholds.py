...
# xgb_df50 = load_data(base_dir, "/06_models/xgboost/xgboost_nested_cv_master_results_file_min50vals.csv")
# xgb_df100 = load_data(base_dir, "/06_models/xgboost/xgboost_nested_cv_master_results_file_min100vals.csv")
# xgb_df150 = load_data(base_dir, "/06_models/xgboost/xgboost_nested_cv_master_results_file_min150vals.csv")
# xgb_df200 = load_data(base_dir, "/06_models/xgboost/xgboost_nested_cv_master_results_file_min200vals.csv")
...
def plot_r2(base_dir, df50, df100, df150, df200, plot_title, save_path):
    ...
    plt.title(f'Linear regression R² across Thresholds', fontsize=20)
