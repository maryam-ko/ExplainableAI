...
def parse_arguments():
    ...
    parser.add_argument('--thresholds', nargs='+', type=int, default=[100], 
...
if __name__ == '__main__':
    ...
    for threshold in args.thresholds:
        matrix = pd.read_csv(f'{args.base_dir}/04_clustering/clustered_matrix_min{threshold}vals.csv', header=0)
