...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/ac9b00024_si_002.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/LY2019.csv', index=False)
