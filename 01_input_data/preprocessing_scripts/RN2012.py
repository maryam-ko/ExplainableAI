...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/Supplemental Table 3.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/RN2012.csv', index=False)
