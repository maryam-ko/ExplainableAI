...
data = pd.read_csv('/Users/maryamkoddus/Documents/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/Supplemental Table 3.csv', header=0)
...
data['Phosphosite Probability Value'] = data['Phosphosite Probability'].str.extract(r'\(([\d\.]+)\)').astype(float)

data = data[data['Phosphosite Probability Value'] >= 0.85]

print(data[['Phosphosite Probability', 'Phosphosite Probability Value']].head())
...
data['Phosphosite'] = data['Phosphorylated Site'].astype(str) + '(' + data['Unnamed: 11'].astype(str) + ')'

keepcols = ['Phosphosite', 'GeneName'] + [col for col in data.columns if col in ['H01', 'H02', 'H03', 'H04', 'H05', 'H06', 'L10', 'L11', 'L12', 'L13', 'L14', 'L15']]
data = data[keepcols]
data

quant_columns = [col for col in data.columns if col in ['H01', 'H02', 'H03', 'H04', 'H05', 'H06', 'L10', 'L11', 'L12', 'L13', 'L14', 'L15']]
...
def log2_transform(dataset):
    ...
    '''
    cols_to_transform = [col for col in data.columns if col in ['H01', 'H02', 'H03', 'H04', 'H05', 'H06', 'L10', 'L11', 'L12', 'L13', 'L14', 'L15']]
...
data.to_csv(f'/Users/maryamkoddus/Documents/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/RN2012.csv', index=False)
