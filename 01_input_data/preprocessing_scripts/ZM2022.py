...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/Supplemental_Tables_S1-S6.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/ZM2022.csv', index=False)
