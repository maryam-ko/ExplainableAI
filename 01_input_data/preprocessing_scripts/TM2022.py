...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/pr2c00198_si_006.csv', header=0)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [col for col in data.columns if any(keyword in col for keyword in ['S2', 'mock'])]
data = data[keepcols]
data

log2_columns = [col for col in data.columns if any(keyword in col for keyword in ['S2', 'mock'])]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/TM2022.csv', index=False)
