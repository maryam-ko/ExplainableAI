...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/pr2c00198_si_006.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/TM2022.csv', index=False)
