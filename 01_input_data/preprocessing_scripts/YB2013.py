...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/41598_2013_BFsrep03460_MOESM1_ESM.csv', header=0)
...
Ratio_columns = [col for col in data.columns if 'Ratio H/L Normalized' in col]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/YB2013.csv', index=False)
