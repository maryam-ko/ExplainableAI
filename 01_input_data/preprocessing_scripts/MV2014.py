...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/e22-sup-tables1.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/MV2014.csv', index=False)
