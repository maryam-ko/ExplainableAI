...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/mmc3 (3).csv', header=0)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [col for col in data.columns if 'Log2_' in col]
data = data[keepcols]
data

log2_columns = [col for col in data.columns if 'Log2_' in col]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/KBE2022.csv', index=False)
