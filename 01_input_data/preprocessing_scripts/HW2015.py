...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/1-s2.0-S1570963914002258-mmc2.csv', header=0)
...
Ratio_columns = [
    'Ratio M/L normalized Exp1',
    'Ratio M/L normalized Exp2',
    'Ratio M/L normalized Exp3',
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/HW2015.csv', index=False)
