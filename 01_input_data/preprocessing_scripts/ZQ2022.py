...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/mc23462-sup-0002-supporting_tables.csv', header=2)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/ZQ2022.csv', index=False)
