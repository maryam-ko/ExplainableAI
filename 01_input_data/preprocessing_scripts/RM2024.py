...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/mmc2 (4).csv', header=1)
...
Intensity_columns = [
    'Intensity', 'Intensity D0-1', 'Intensity D0-2', 'Intensity D0-3',
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/RM2024.csv', index=False)
