...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/Table 1.csv', header=5)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/RNJ2017.csv', index=False)
