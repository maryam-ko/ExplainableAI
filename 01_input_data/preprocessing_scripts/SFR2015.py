...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/aab3138_table_s2.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/SFR2015.csv', index=False)
