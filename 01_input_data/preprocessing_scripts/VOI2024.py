...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/1-s2.0-S0041010124006445-mmc1.csv', header=0)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [col for col in data.columns if col.startswith('Veh') or col.startswith('0.1uM')] 
data = data[keepcols]
data

log_columns = [col for col in data.columns if col.startswith('Veh') or col.startswith('0.1uM')] 
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/VOI2024.csv', index=False)
