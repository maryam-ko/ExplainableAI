...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/mcp.O111.012351-2.csv', header=0)
print('Raw data loaded.')
data

data = data[data['Phospho (STY) Probabilities'].str.contains(r'\(\s*0\.(8[5-9]|9[0-9]|99[0-9]*|[1-9]\d*)\)', regex=True, na=False)]

# Extract amino acid (single letter) and position (number)
data[['Amino acid', 'Positions within proteins']] = data['Phosphosite(s)'].str.extract(r'([A-Z])(\d+)', expand=True)

data = data[~data['Amino acid'].str.contains(';', na=False)]
data['Positions within proteins'] = data['Positions within proteins'].astype(int)
...
ratio_columns = [
    'Ratio -/+ 3-MB-PP1 exp. as1a', 'Ratio -/+ 3-MB-PP1 exp. as1b', 'Ratio -/+ 3-MB-PP1 exp. as2a',
    'Ratio -/+ 3-MB-PP1 exp. as2b', 'Ratio -/+ 3-MB-PP1 exp. as3a', 'Ratio -/+ 3-MB-PP1 exp. as3b',
    'Ratio -/+ 3-MB-PP1 exp. as4a', 'Ratio -/+ 3-MB-PP1 exp. as4b', 'Ratio -/+ 3-MB-PP1 exp. wt1a',
    'Ratio -/+ 3-MB-PP1 exp. wt1b', 'Ratio -/+ 3-MB-PP1 exp. wt2a', 'Ratio -/+ 3-MB-PP1 exp. wt2b',
    'Ratio -/+ 3-MB-PP1 exp. wt3a', 'Ratio -/+ 3-MB-PP1 exp. wt3b', 'Ratio -/+ 3-MB-PP1 exp. wt4a',
    'Ratio -/+ 3-MB-PP1 exp. wt4b', 'Ratio -/+ 3-MB-PP1 exp. as1', 'Ratio -/+ 3-MB-PP1 exp. as2',
    'Ratio -/+ 3-MB-PP1 exp. as3', 'Ratio -/+ 3-MB-PP1 exp. as4', 'Ratio -/+ 3-MB-PP1 exp. wt1',
    'Ratio -/+ 3-MB-PP1 exp. wt2', 'Ratio -/+ 3-MB-PP1 exp. wt3', 'Ratio -/+ 3-MB-PP1 exp. wt4'
]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/FSO2012.csv', index=False)
