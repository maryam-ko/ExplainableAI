...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/mmc3 (1).csv', header=1)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [col for col in data.columns if col.startswith('Ctr') or col.startswith('db/db')]
data = data[keepcols]
data
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/FS2019.csv', index=False)
