...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/pone.0024918.s001.csv', header=3)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/JAW2011.csv', index=False)
