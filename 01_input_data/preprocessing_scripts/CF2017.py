...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/mmc4.csv', header=0)
...
def match_seq_to_genename(dataset, seq_column):
    ...
    fasta_sequence = list(SeqIO.parse(f"/data/home/bt24990/ExplainableAI/01_input_data/raw_data/UP000005640_9606.fasta", "fasta"))
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/CF2017.csv', index=False)
