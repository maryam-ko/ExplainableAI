...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/embj201899559-sup-0006-datasetev1.csv', header=0)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [
    'normalised rep. int. CDK5L-1', 
    'normalised rep. int. CDK5L-2', 
    'normalised rep. int. CDK5L-3', 
    'normalised rep. int. Empty-1', 
    'normalised rep. int. Empty-2', 
    'normalised rep. int. Empty-3'
]
data = data[keepcols]
data

existing_columns = [col for col in keepcols if col in data.columns]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/IMM2018.csv', index=False)
