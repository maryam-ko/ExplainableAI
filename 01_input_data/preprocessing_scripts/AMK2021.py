...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/pr1c00447_si_002.csv', header=2)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/AMK2021.csv', index=False)
