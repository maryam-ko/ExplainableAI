...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/pr400417g_si_006.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/FSO2013.csv', index=False)
