...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/pr400417g_si_006.csv', header=0)
...
Ratio_columns = [
    'Ratio M/L normalized Rep1', 'Ratio M/L normalized Rep1___1', 'Ratio M/L normalized Rep1___2', 
    'Ratio M/L normalized Rep1___3', 'Ratio H/L normalized Rep1', 'Ratio H/L normalized Rep1___1',
    'Ratio H/L normalized Rep1___2', 'Ratio H/L normalized Rep1___3', 'Ratio H/M normalized Rep1',
    'Ratio H/M normalized Rep1___1', 'Ratio H/M normalized Rep1___2', 'Ratio H/M normalized Rep1___3',
    'Ratio M/L normalized Rep2', 'Ratio M/L normalized Rep2___1', 'Ratio M/L normalized Rep2___2',
    'Ratio M/L normalized Rep2___3', 'Ratio H/L normalized Rep2', 'Ratio H/L normalized Rep2___1',
    'Ratio H/L normalized Rep2___2', 'Ratio H/L normalized Rep2___3', 'Ratio H/M normalized Rep2',
    'Ratio H/M normalized Rep2___1', 'Ratio H/M normalized Rep2___2', 'Ratio H/M normalized Rep2___3',
    'Ratio M/L normalized Rep3', 'Ratio M/L normalized Rep3___1', 'Ratio M/L normalized Rep3___2',
    'Ratio M/L normalized Rep3___3', 'Ratio H/L normalized Rep3', 'Ratio H/L normalized Rep3___1',
    'Ratio H/L normalized Rep3___2', 'Ratio H/L normalized Rep3___3', 'Ratio H/M normalized Rep3',
    'Ratio H/M normalized Rep3___1', 'Ratio H/M normalized Rep3___2', 'Ratio H/M normalized Rep3___3'
]

keepcols = ['Phosphosite'] + ['GeneName'] + Ratio_columns
data = data[keepcols]
data
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/FSO2013.csv', index=False)
