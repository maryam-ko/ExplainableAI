...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/pr2c00244_si_005.csv', header=5)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/DB2022.csv', index=False)
