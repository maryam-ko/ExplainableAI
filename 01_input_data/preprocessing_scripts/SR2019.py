...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/42003_2019_570_MOESM4_ESM.csv', header=1, skiprows=[2])
...
keepcols = ['Phosphosite'] + ['GeneName'] + [
    'Intensity BT549 Biol. repl. 1', 'Intensity BT549 Biol. repl. 2', 'Intensity BT549 Biol. repl. 3', 'Intensity BT549 Biol. repl. 4',
    'Intensity Hs578T Biol. repl. 1', 'Intensity Hs578T Biol. repl. 2', 'Intensity Hs578T Biol. repl. 3', 'Intensity Hs578T Biol. repl. 4',
    'Intensity LM2 Biol. repl. 1', 'Intensity LM2 Biol. repl. 2', 'Intensity LM2 Biol. repl. 3', 'Intensity LM2 Biol. repl. 4',
    'Intensity MDAMB231 Biol. repl. 1', 'Intensity MDAMB231 Biol. repl. 2', 'Intensity MDAMB231 Biol. repl. 3', 'Intensity MDAMB231 Biol. repl. 4',
    'Intensity HCC1419 Biol. repl. 1', 'Intensity HCC1419 Biol. repl. 2', 'Intensity HCC1419 Biol. repl. 3', 'Intensity HCC1419 Biol. repl. 4',
    'Intensity HCC1954 Biol. repl. 1', 'Intensity HCC1954 Biol. repl. 2', 'Intensity HCC1954 Biol. repl. 3', 'Intensity HCC1954 Biol. repl. 4',
    'Intensity JIMT1 Biol. repl. 1', 'Intensity JIMT1 Biol. repl. 2', 'Intensity JIMT1 Biol. repl. 3', 'Intensity JIMT1 Biol. repl. 4',
    'Intensity SKBR3 Biol. repl. 1', 'Intensity SKBR3 Biol. repl. 2', 'Intensity SKBR3 Biol. repl. 3', 'Intensity SKBR3 Biol. repl. 4',
    'Intensity MCF7 Biol. repl. 1', 'Intensity MCF7 Biol. repl. 2', 'Intensity MCF7 Biol. repl. 3', 'Intensity MCF7 Biol. repl. 4',
    'Intensity MCF10A Biol. repl. 1', 'Intensity MCF10A Biol. repl. 2', 'Intensity MCF10A Biol. repl. 3', 'Intensity MCF10A Biol. repl. 4', 'Intensity'
]

data = data[keepcols]
data

data[log2_col] = data[log2_col].apply(pd.to_numeric, errors="coerce")
...
def log2_transform(dataset):
    ...
    '''
    cols_to_transform = dataset[log2_col]
    dataset[log2_col] = cols_to_transform.apply(np.log2)
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/SR2019.csv', index=False)
