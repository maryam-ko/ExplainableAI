...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/42003_2019_570_MOESM4_ESM.csv', header=1, skiprows=[2])
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/SR2019.csv', index=False)
