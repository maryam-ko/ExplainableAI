...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/BSR-2021-1326_suppSD1.csv', header=1)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/JW2021.csv', index=False)
