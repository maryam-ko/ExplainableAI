...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/Supplementary table3.csv', header=2)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/ZX2022.csv', index=False)
