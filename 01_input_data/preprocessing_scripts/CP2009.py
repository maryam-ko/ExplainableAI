...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/Supplementary_Table_7.csv', header=1)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/CP2009.csv', index=False)
