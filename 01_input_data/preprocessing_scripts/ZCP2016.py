...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/mmc2(2).csv', header=1)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/ZCP2016.csv', index=False)
