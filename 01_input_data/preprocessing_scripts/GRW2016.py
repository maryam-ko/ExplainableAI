...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/1-s2.0-S1046202315300104-mmc3.csv', header=1)
print('Raw data loaded.')
data

data.columns = data.columns.str.strip()

data = data[data['Modifications'].str.match(r'^(Phospho \(STY\)|2 Phospho \(STY\)|3 Phospho \(STY\))$', na=False)]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/GRW2016.csv', index=False)
