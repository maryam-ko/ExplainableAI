...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/1-s2.0-S1046202315300104-mmc3.csv', header=1)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/GRW2016.csv', index=False)
