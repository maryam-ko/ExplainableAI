...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/1-s2.0-S0006291X18320114-mmc2.csv', header=0)
...
log2_cols = ['Log2(SKBR3-LR/SKBR3)_Rep.1-1',	
             'Log2(SKBR3-LR/SKBR3)_Rep.1-2',
             'Log2(SKBR3-LR/SKBR3)_Rep.2-1',	
             'Log2(SKBR3-LR/SKBR3)_Rep.2-2']
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/YC2018.csv', index=False)
