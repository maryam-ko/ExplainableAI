...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/1-s2.0-S0166354223002395-mmc2.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/DL2023.csv', index=False)
