...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/2004856_TableS7.csv', header=3)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/RCJD2014.csv', index=False)
