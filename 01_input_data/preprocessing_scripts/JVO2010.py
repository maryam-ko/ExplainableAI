...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/supplementarytable_s2.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/JVO2010.csv', index=False)
