...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/iub1987-sup-0002-tables2.csv', header=3)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [
    col for col in data.columns if 'Ratio' in col and 'mean' not in col
]
data = data[keepcols]
data
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/MM2018.csv', index=False)
