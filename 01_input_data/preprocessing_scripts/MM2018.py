...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/iub1987-sup-0002-tables2.csv', header=3)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/MM2018.csv', index=False)
