...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/mmc3.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/KS2014.csv', index=False)
