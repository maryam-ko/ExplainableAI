...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/thnov10p2115s2.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/YA2020.csv', index=False)
