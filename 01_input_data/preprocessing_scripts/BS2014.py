...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/ijms-15-12007-s001.csv', header=1)
...
keepcols = ['Phosphosite'] + ['GeneName'] + [
    ...
    if 'Log2(Ratio H/L' in col and 'Significance' not in col and 'significant' not in col
]
data = data[keepcols]
data
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/BS2014.csv', index=False)
