...
data = pd.read_csv('/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/raw_data/2012AUTO0670R2-TableS1-S5.csv', header=0)
...
data[['Amino acid', 'Positions within proteins']] = data['Position'].str.extract(r'([A-Z])(\d+)')
...
Ratio_columns = [
    'Ratio-AA 2 mins', 'Ratio-AA 7 mins', 'Ratio-AA 15 mins', 'Ratio-AA 30 mins',
    'Ratio-Rapa 2 mins', 'Ratio-Rapa 7 mins', 'Ratio-Rapa 15 mins', 'Ratio-Rapa 30 mins',
    'Ratio M L Normalized Rep1_AA_starvation_0_15', 'Ratio H L Normalized Rep1_AA_starvation_0_15',
    'Ratio H M Normalized Rep1_AA_starvation_0_15', 'Ratio M L Normalized Rep2_AA_starvation_0_15',
    'Ratio H L Normalized Rep2_AA_starvation_0_15', 'Ratio H M Normalized Rep2_AA_starvation_0_15',
    'Ratio M L Normalized Rep1_Rapamycin_0_15', 'Ratio H L Normalized Rep1_Rapamycin_0_15',
    'Ratio H M Normalized Rep1_Rapamycin_0_15', 'Ratio M L Normalized Rep2_Rapamycin_0_15',
    'Ratio H L Normalized Rep2_Rapamycin_0_15', 'Ratio H M Normalized Rep2_Rapamycin_0_15'
]
...
data.to_csv(f'/data/home/bt24990/maryam-ko-QMUL-MSc-Project/01_input_data/PreprocessedDatasets/KTGR2014.csv', index=False)
