...
data = pd.read_csv('/data/home/bt24990/ExplainableAI/01_input_data/raw_data/2012AUTO0670R2-TableS1-S5.csv', header=0)
...
data.to_csv(f'/data/home/bt24990/ExplainableAI/01_input_data/PreprocessedDatasets/KTGR2014.csv', index=False)
