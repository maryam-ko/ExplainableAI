...
if __name__ == '__main__':
    ...
    matrix = pd.read_csv(f'{args.base_dir}/04_clustering/interim_data/clustered_matrix.csv', header=0)
    ...
    for threshold in args.thresholds:
        ...
        matrix_filtered.to_csv(f'{args.base_dir}/04_clustering/interim_data/clustered_matrix_min{threshold}vals.csv', index=True)
