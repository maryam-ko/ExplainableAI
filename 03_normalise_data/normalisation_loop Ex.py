...
matrix = pd.read_csv('C:/Users/tnaom/OneDrive/Desktop/PPA/02_raw_matrix/RawMatrix_NoOutliers.csv', header = 0)
...
combined_df.to_csv('combined_scaled_matrix.csv', index=True, index_label="DatasetName")
