...
raw_matrix = pd.read_csv('/data/home/bt24990/ExplainableAI/02_raw_matrix/MatrixCSVs/RawMatrix.csv', header = 0)
...
raw_matrix_no_outliers.to_csv('/data/home/bt24990/ExplainableAI/02_raw_matrix/MatrixCSVs/RawMatrix_NoOutliers.csv', index=True)
