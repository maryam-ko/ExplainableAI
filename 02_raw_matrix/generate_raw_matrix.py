...
matrix = pd.read_csv('/data/home/bt24990/ExplainableAI/02_raw_matrix/RawMatrixProcessing/raw-matrix-header.csv', header = 0)
...
raw_matrix.to_csv('//data/home/bt24990/ExplainableAI/02_raw_matrix/MatrixCSVs/RawMatrix.csv', index=False)
print('Raw matrix saved successfully!')

# ----------------- #

df = pd.read_csv(f'/data/home/bt24990/ExplainableAI/02_raw_matrix/MatrixCSVs/RawMatrix.csv')
df.shape