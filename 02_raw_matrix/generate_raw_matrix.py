...
file_names = ['AST2020', 'CF2017', 'EJN2021', 'HH2022', 'KS2014', 'MV2014', 'NJH2015', 'NJH2024', 'RB2022', 'RN2012', 'RNJ2017', 'ZQ2022']
...
matrix = pd.read_csv('/Users/maryamkoddus/Documents/maryam-ko-QMUL-MSc-Project/RawMatrixProcessing/raw-matrix-header.csv', header = 0)
...
files_datasets = [('MC2020', MC2020_names), ('TK2018', TK2018_names), 
            ('RP2022', RP2022_names), ('RP2023', RP2023_names),
            ('LY2021', LY2021_names), ('VB2014', VB2014_names),
            ('KK2015score', KK2015score_names), ('KK2015heat', KK2015heat_names),
            ('KK2015cold', KK2015cold_names), ('HT2009', HT2009_names),
            ('LP2019', LP2019_names), ('ZW2019', ZW2019_names),
            ('GP2021', GP2021_names), ('CP2024a', CP2024a_names),
            ('CP2024b', CP2024b_names), ('CP2024c', CP2024c_names),
            ('CP2024d', CP2024d_names), ('CP2024e', CP2024e_names),files_dict
            # ('KS2024a', KS2024a_names), ('KS2024b', KS2024b_names),
            ('PC2024a', PC2024a_names), ('PC2024b', PC2024b_names),
            ('PC2024c', PC2024c_names), ('PC2024d', PC2024d_names),
            ('PC2024e', PC2024e_names), ('PC2024f', PC2024f_names),
            ('PC2024g', PC2024g_names), ('PC2024h', PC2024h_names),
            ('PC2024i', PC2024i_names), ('DS2021', DS2021_names),
            ('SW2021', (SW2021_names,)), ('VA2020', VA2020_names),
            ('SC2021a', SC2021a_names), ('SC2021b', SC2021b_names),
            ('SF2023', (SF2023_names,)), ('GP2024', (GP2024_names,)),
            ('EC2021', EC2021_names), ('LT2024', LT2024_names)]
...
# save raw matrix
raw_matrix.to_csv('/data/home/bty449/ExplainableAI/MatrixCSVs/RawMatrix.csv', index=False)
