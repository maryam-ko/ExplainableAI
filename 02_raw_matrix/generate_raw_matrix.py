...
JB2023_names = (
    ...
    [f'JB2023_Intensity {group}' for group in [
    ...
    [f'JB2023_Intensity {group}___{i}' for group in [
        '20220718_C28798_002_S397439_M2_prim_IIM_R3_Group_4', '20220718_C28798_003_S397432_M2_prim_IS_R4_Group_2',
        '20220718_C28798_004_S397437_M2_prim_IIM_R1_Group_4', '20220718_C28798_005_S397438_M2_prim_IIM_R2_Group_4',
        '20220718_C28798_007_S397436_M2_prim_FCM_R4_Group_3', '20220718_C28798_008_S397429_M2_prim_IS_R1_Group_2',
        '20220718_C28798_009_S397426_M2_prim_NT_R2_Group_1', '20220718_C28798_010_S397425_M2_prim_NT_R1_Group_1',
...
files_datasets = [
    ...
    ('FR2021', FR2021_names),
    ('FS2019', FS2019_names),
    ('FSO2012', FSO2012_names),
    ('FSO2013', FSO2013_names),
    ('GF2025', GF2025_names),
    ('GRW2016', GRW2016_names),
    ('HH2022', HH2022_names),
    ('HS2024', HS2024_names),
    ('HW2015', HW2015_names),
    ('IMM2018', IMM2018_names),
    ...
    ('JW2015', JW2015_names),
    ('JW2021', JW2021_names),
    ('KBE2022', KBE2022_names),
    ('KDH2022', KDH2022_names),
    ('KS2014', KS2014_names),
    ('KTGR2014', KTGR2014_names),
    ...
    ('NJH2025', NJH2025_names),
    ('PG2020', PG2020_names),
    ('RAM2015', RAM2015_names),
    ('RB2022', RB2022_names),
    ('RBK2021', RBK2021_names),
    ('RCJD2014', RCJD2014_names),
    ('RKK2015', RKK2015_names),
    ('RM2009', RM2009_names),
    ('RM2024', RM2024_names),
    ('RN2012', RN2012_names),
    ('RNJ2017', RNJ2017_names),
    ('SAS2015', SAS2015_names),
    ('SFR2015', SFR2015_names),
    ('SR2019', SR2019_names),
    ('TM2022', TM2022_names),
    ('UK2020', UK2020_names),
    ('VOI2024', VOI2024_names),
    ('WZ2023', WZ2023_names),
    ('YA2020', YA2020_names),
    ('YB2013', YB2013_names),
    ('YC2018', YC2018_names),
...
if 'DatasetName' in cols:
    cols.remove('DatasetName')
    cols = ['DatasetName'] + cols  
